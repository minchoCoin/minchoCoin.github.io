...
## CPUUsage
이 필드는 OS_cfg에서 OS_CFG_TASK_PROFILE_EN이 1로 설정된 경우 OS_StatTask()에 의해 계산된다. CPUUage는 작업의 CPU 사용량을 백분율(0 ~ 100%)로 포함합니다. 버전 V3.03.00에서는 .CPUUage에 100을 곱합니다. 즉, 10000은 100.00%를 의미한다.
